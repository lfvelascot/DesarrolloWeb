...
if ($estado == "ACTIVA" ){
	...
	$update = "UPDATE cuenta SET estado = 'ACTIVA' WHERE usuario = $id;";
}
if (mysqli_query($con,$update)){
	...
	include_once("date.php");
	$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Cuenta Modificado Fallido','Conflicto con la actualizacion del estado de la cuenta del usuario : $usuario',1);";
	mysqli_query($con,$inserta);
	mysqli_close($con);
	header("Location: buscarCuenta.php?ccc=$id&add=");
	die();

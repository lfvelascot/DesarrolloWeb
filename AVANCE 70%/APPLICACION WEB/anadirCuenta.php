	...
	if ($vcontr1 == $vcontr2){
		if ((strpos($vcorreo, ".com") !== false | strpos($vcorreo, ".co") !== false)){
			...
			if(mysqli_num_rows($result) == 0){
				...
				$sql = "INSERT INTO cuenta VALUES ('$correoe','$conte','$vestado','$perfil',$vusario,1);"; 
				if (mysqli_query($con,$sql)){
					...
					include_once("date.php");
					$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Cuenta Añadido Fallido','Conflico con los datos de la Cuenta($correoe)',1);";
					mysqli_query($con,$inserta);
					mysqli_close($con);

  ...
  <tr bgcolor="#B1F0FE">
    ...
    <td><a class="btn btn-primary" href="eliminarUsuario1.php?id=<?php echo $mostrar['cc'];?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>Eliminar</a></td>
      	...
      	<?php 
			...
			$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Usuarios Vistos','Se vieron todos los registros de Usuarios de APPAUSA WEB');";
...
<div id="apDiv4">
  <h1 align="center">Eliminar Usuario</h1></div></div>
</div>
</body>
</html>

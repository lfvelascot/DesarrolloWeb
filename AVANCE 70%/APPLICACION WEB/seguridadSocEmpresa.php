...
<h2 align="center">Entidades Existentes</h2>
  <table width="571" height="96" border=1 cellspacing=0 cellpadding=2 bordercolor="666633">
    ...
    <?php }
			...
			$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Seguridad Social Vista','Se buscaron las entidades contratas en por parte de la empresa $nombre para la Seguridad social de sus empleados',1);";

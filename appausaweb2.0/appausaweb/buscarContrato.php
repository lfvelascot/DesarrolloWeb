...
<form>
    ...
    <td width="799" bgcolor="#FFFFFF"><input type="text" name="cempresa" pattern="^[0-9]{0,14}+-[{0-9}]$"/> </td>
    </tr>
    <?php }?>
    </table>
...
<table width="1158" height="306" border=1 cellspacing=0 cellpadding=2 bordercolor="666633">
  ...
  <?php
    ...
    <?php }
		...
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Contrato Buscado','Se Buscaron los datos del Contrato:$contrato de la Empresa:$empresa',1);";

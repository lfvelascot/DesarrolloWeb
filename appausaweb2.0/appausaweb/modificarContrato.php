...
<div id="apDiv4">
<h1 align="center">Modificar Contrato</h1></div>
...
<table width="1158" height="306" border=1 cellspacing=0 cellpadding=2 bordercolor="666633">
  ...
  <?php
    ...
    <?php }
		...
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Contratos Vistos','Se Buscaron los datos de todos los Contratos para Eliminar');";

...
<div id="apDiv1">
<div id="apDiv2">
<form> <p> Ingrese el número de cedula del Empleado a buscar: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="20" name="ccc" pattern="^((\d{8})|(\d{10})|(\d{11})|(\d{6}-\d{5}))?$"> <button type="submit" name="buscar">Buscar</button></form></p>
</div>
<div id="apDiv3">

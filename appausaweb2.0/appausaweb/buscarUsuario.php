...
<div id="apDiv1">
<div id="apDiv2">
<form> <p> Ingrese el número de cedula del Usuario a buscar: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="20" name="ccc" pattern="^((\d{8})|(\d{10})|(\d{11})|(\d{6}-\d{5}))?$"> <button type="submit" name="buscar">Buscar</button></form></p>
</div>
<div id="apDiv3">
  ...
  <tr>
    ...
    <td><a class="btn btn-primary"  href="modificarUsuario1.php?id=<?php echo $mostrar['cc']; ?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>Modificar</a></td>
      	...
      	<?php 
			...
			$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Usuario Buscado','Se Buscaron los datos del Usuario:$id',1);";

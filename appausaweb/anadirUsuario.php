...
<table width="1114" height="274" border="0">
  <tr>
    ...
    <td width="325"><input type="text" name="cnumdoc" value ="<?php if (isset($_GET['error'])) {echo $vcc;} else {echo "";}?>"/></td>
  ...
  <tr>
    ...
    <td><input type="email" name="ccorreo" value="<?php if (isset($_GET['error'])) {echo $vcorreo;} else {echo "";}?>" required /></td>
  </tr>
  <tr>
    <td><p>Teléfono:</p></td>
    <td><input type="number" value="<?php if (isset($_GET['error'])) {echo $vtelefono;} else {echo "";}?>" name="ctelefono" /></td>
  </tr>
  <tr>
    <td><p>Rol:</p></td>
    <td><select name="crol">

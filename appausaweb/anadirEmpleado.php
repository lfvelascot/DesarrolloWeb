...
<table width="1114" height="274" border="0">
  <tr>
    ...
    <td width="325"><input type="text" value ="<?php if (isset($_GET['error'])) {echo $vcc;} else {echo "";}?>" name="cnumdoc" /></td>
  ...
  <tr>
    ...
    <td><input type="email" value="<?php if (isset($_GET['error'])) {echo $vcorreo;} else {echo "";}?>" name="ccorreo" required /></td>
    <td><p>Teléfono:</p></td>

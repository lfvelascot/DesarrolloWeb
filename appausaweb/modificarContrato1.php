  ...
  <table width="900" height="550" border="0">
    ...
    <tr>
      ...
      <td><input type="text" value="<?php echo $mostrar['empresa'];?>" name="cnitempresa" autofocus required /></td>
    </tr>
      <tr>
      <td><p>Documento Empleado:</p></td>
      <td><input type="text" value="<?php echo $mostrar['empleado'];?>" name="cdocumentoemp" autofocus required /></td>
    </tr>
    <tr>

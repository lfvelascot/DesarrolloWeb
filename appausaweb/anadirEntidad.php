...
if (isset($_GET['add']) && $_GET['ctipo'] != "0"){
	...
	$sql = "INSERT INTO $bd.entidad VALUES ('$vnit','$vnombre','$vtipo','$vtelefono','$vdir','$vcorreo',1)";
	if (mysqli_query($con,$sql)){
		include_once("date.php");
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Entidad Añadida Exitoso','Se ingresaron los datos de la Entidad: $vnit',1);";
		...
		include_once("date.php");
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Entidad Añadida Fallido','Se trataron de ingresar los datos de la entidad $vnombre',1);";
		mysqli_query($con,$inserta);
		mysqli_close($con);

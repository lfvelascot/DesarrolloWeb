...
<table width="915" height="206" border="0">
  <tr>
    ...
    <td width="572"><input type="number" name="cdusuario" value="<?php if ($b){echo $vusario; } else { echo "";}?>" required="required"/></td>
  </tr>
  <tr>
    <td><p>Correo Electronico:</p></td>
    <td><input type="email" name="cmail" value="<?php if ($b){echo $vcorreo ; } else { echo "";}?>" required="required"/></td>
  </tr>
  <tr>

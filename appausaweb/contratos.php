...
<div id="apDiv4">
<h1 align="center">Contratos (Doc. <?php echo $emp ?>)</h1></div>
<div id="apDiv6">
  ...
  <?php
		...
		$emp = $_GET['emp'];
		$sql="SELECT * from contrato WHERE empleado = '$emp';";
    ...
    <?php }
		...
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Contratos Vistos','Se vieron todos los registros de los Contratos');";

...
<table width="1332" height="212" border=1 cellspacing=0 cellpadding=2 bordercolor="666633">
  <tr bgcolor="#B1F0FE">
	...
	<?php if ($mostrar['rol'] != "ADMINISTRADOR"){?>
    ...
    <td><a class="btn btn-primary"  href="modificarUsuario1.php?id=<?php echo $mostrar['cc']; ?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>Modificar</a></td>
      	...
      	<?php 
			...
			$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Usuarios Vistos','Se vieron todos los registros de Usuarios de APPAUSA WEB',1);";
...
<div id="apDiv4"><h1 align="center">Usuarios</h1></div></div>
</div>
</body>
</html>

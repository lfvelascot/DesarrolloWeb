...
<table width="1043" height="265" border="0">
  ...
  <tr>
    ...
    <td><textarea name="cdescrip" value= "<?php if (isset($_GET['error'])) { echo $_GET['edes'];} else { echo ""; }?>" rows="10" cols="90">Descripcion de la empresa</textarea></td>
  </tr>
</table>
...
if (isset($_GET['add']) && $_GET['ctipo'] != "0"){
	...
	$sql = "INSERT INTO $bd.empresa (`nit`, `nombre_empresa`, `direccion`, `email`, `telefono`, `descripción_empresa`, `num_empleados`, `tipo_empresa`, `inicio_actividad`, `fin_actividad`, `e`) VALUES ('$vnit','$vnombre','$vdir','$vcorreo','$vtelefono','$vdescrip',0,'$vtipo',$vinicio,$vfin,1)";
	if (mysqli_query($con,$sql)){
		include_once("date.php");
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Empresa Añadida Exitoso','Se ingresaron los datos de la empresa: $vnit',1);";
		...
		include_once("date.php");
		$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Empresa Añadida Fallido','($vcc,$vtipodoc,$vnombre,$vapellido,$vfechanam,$vedad,$vcorreo,$vtelefono,$vrol,1)',1);";
		mysqli_query($con,$inserta);
		mysqli_close($con);

    ...
    <table width="1179" height="163" border="1" cellspacing="0" cellpadding="2" bordercolor="666633">
      ...
      <?php
        ...
        <?php }
			...
			$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Perfiles Vistos','Se vieron todos los perfiles del sistema asociados con el rol: $rolus para asigarle uno a la cuenta del usuario: $usuario',1);";

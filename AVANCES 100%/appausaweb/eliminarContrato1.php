...
if ($result=mysqli_query($con,$sql)){
		...
		$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Contrato Eliminado Exitoso','Se Eliminaron los datos del Contrato identificado con el Numero: $contrato de la empresa: $empresa ',1);";
		...
		include_once("date.php");
		$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Contrato Eliminado Fallido','Se Trataron de eliminar los datos de Contrato identificado con el Numero: $contrato de la empresa: $empresa ',1);";
		mysqli_query($con,$inserta);
		mysqli_close($con);

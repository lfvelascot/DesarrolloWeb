  ...
  <tr bgcolor="#B1F0FE">
    ...
    <td><b>Opción</b></td>
  	...
  	<?php
		...
		$sql="SELECT DISTINCT usuario.* from usuario,contrato WHERE usuario.cc = contrato.empleado AND contrato.empresa = $empresa_ses AND usuario.cc != $cc_ses AND contrato.empleado != $cc_ses AND usuario.e = 1 AND usuario.rol = 'EMPLEADO';";
    ...
    <td><a class="btn btn-primary" href="eliminarUsuario1.php?id=<?php echo $mostrar['cc'];?>&empleado="><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>Eliminar</a></td>
      	...
      	<?php 
			...
			$inserta = "INSERT INTO $bd.log VALUES ('$user_ses','$f','Empleados Vistos','Se vieron todos los registros de Empleados de la Empresa: $empresa_ses');";
...
<div id="apDiv4">
  <h1 align="center">Eliminar Empleado</h1></div></div>
</div>
</body>
</html>

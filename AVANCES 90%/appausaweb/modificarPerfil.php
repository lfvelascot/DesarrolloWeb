...
<div id="apDiv1">
  <div id="apDiv3">
    <table width="1179" height="224" border="1" cellspacing="0" cellpadding="2" bordercolor="666633">
      ...
      <?php
		...
		<td><a href="modificarPerfil1.php?perfil=<?php echo $mostrar['nombre']?>&descrip=<?php echo $mostrar['descrpción']?>&rol=<?php echo $mostrar['rol_asociado']?>&submit">Modificar Datos</a></td>
        ...
        <?php }
			...
			$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Perfiles Vistos','Se vieron todos los perfiles del sistema',1);";
  ...
  <div id="apDiv4">
  <h1 align="center">Modificar Perfil</h1></div>

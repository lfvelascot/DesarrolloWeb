...
<table width="1043" height="265" border="0">
  ...
  <tr>
    <td><p>Teléfono:</p></td>
    <td><input type="tel" name="ctel" value= "<?php if (isset($_GET['error'])) { $vtel = $_GET['etelefono']; $vtel =  $teldesencriptar($vtel); echo $vtel;} else { echo ""; }?>" pattern"^[0-9]\d{7,10}$" title="El numero de telefono debe ser de 7 o 10 digitos" required/></td>
  </tr>
  <tr>

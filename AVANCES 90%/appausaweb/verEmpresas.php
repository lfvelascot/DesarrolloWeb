...
<div id="apDiv1">
  ...
  ?>
    ...
    <td><a href="buscarContratosEmpr.php?cempresa=<?php echo $mostrar['nit']?>&buscar">Ver Contratos</a></td>
  ...
  <?php } } 
	...
	$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Empresas Vistas','Se vieron todos los registros de Empresas inscritas en APPAUSA WEB',1);";

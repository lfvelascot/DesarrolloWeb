...
if (isset($_GET['mod']) && $_GET['crol'] != "0" && $_GET['ctipodoc'] != "0") {
	...
	$inserta = "UPDATE usuario SET cc = $vcc, tipo_doc = '$vtipodoc', nombre = '$vnombre1 $vnombre2', apellido = '$vapellido1 $vapellido2', fecha_nam = '$vfechanam', edad = $vedad, correo_electronico = '$vcorreo', telefono = $vtelefono WHERE cc = '$vcc';";
	if (mysqli_query($con,$inserta)){
		include_once("date.php");
		$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Empleado Modificado Exitoso','Se modificaron los datos del Empleado:$vcc',1);";
		...
		include_once("date.php");
		$inserta = "INSERT INTO log VALUES ('$user_ses','$f','Empleado Modificado Fallido','Trato de ingresar los datos del usuario: $vcc',1);";
		mysqli_query($con,$inserta);
		mysqli_close($con);

...
<h2 align="center">Entidades Contratas</h2>
  <table width="949" height="78" border=1 cellspacing=0 cellpadding=2 bordercolor="666633">
    <tr bgcolor="#B1F0FE">
			...
			while($mostrar=mysqli_fetch_array($result)){
				...
				if(mysqli_num_rows($result1) != 0){
					while($mostrar1=mysqli_fetch_array($result1)){
                        ...
                        <td><?php include_once('mcript.php');$t =  $mostrar1['email'];$t = $teldesencriptar($t); echo $t?></td>
